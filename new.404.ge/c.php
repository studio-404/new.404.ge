...
function scrape_imdb($year_start, $year_end, $page_start, $page_end){
	...
	$url = "https://www.imdb.com/search/title?year=$year_start,$year_end&title_type=feature&sort=moviemeter,asc&page=$page&ref_=adv_nxt";
...
echo "<pre>";
print_r(scrape_imdb(2000, 2001, 1, 2));
?>